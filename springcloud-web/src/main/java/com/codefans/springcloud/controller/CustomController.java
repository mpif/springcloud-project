...
//            list.add(new ResponseDto(httpResponseFuture, response));
    ...
    @PostMapping("/singleRedisReadPerformance")
    public Result singleRedisReadPerformance(@NotNull Long id, HttpServletRequest request) {
        long beginTime = System.currentTimeMillis();
        try {
            syncConCurrentCount.incrementAndGet();
            HttpUtils.syncRequest();
    ...
    @PostMapping("/singleRedisWritePerformance")
    public Result singleRedisWritePerformance(@NotNull Long id, HttpServletRequest request) {
        long beginTime = System.currentTimeMillis();
        try {
            syncConCurrentCount.incrementAndGet();
            HttpUtils.syncRequest();
    ...
    @PostMapping("/clusterRedisReadPerformance")
    public Result clusterRedisReadPerformance(@NotNull Long id, HttpServletRequest request) {
        long beginTime = System.currentTimeMillis();
        try {
            syncConCurrentCount.incrementAndGet();
            HttpUtils.syncRequest();
    ...
    @PostMapping("/clusterRedisWritePerformance")
    public Result clusterRedisWritePerformance(@NotNull Long id, HttpServletRequest request) {
        long beginTime = System.currentTimeMillis();
        try {
            syncConCurrentCount.incrementAndGet();
            HttpUtils.syncRequest();
